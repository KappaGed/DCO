...
public class ClienteExemplo {
	...
	public static void main(String[] args) {
		...
		talvezOutraSessao.ifPresent((Sessao s) -> {
			...
			for (Desafio desafio : pdh.consultarDesafiosPendentes()) {
				pdh.respondeADesafio(desafio.codigo(), disponivel);
				if (!disponivel) {
